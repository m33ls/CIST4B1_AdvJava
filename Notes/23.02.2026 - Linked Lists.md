...
# Doubly Linked Lists
* What we've previously described but you can follow the links in either direction
...
* Arrays
    * Random Access - allows for direct acces of any element in O(1)
* Linked List
...
* Representation of typical "line" forming
    * Like bank teller lines, movie theatre lines, &c.
* Functions
    * Enqueue 
    * Dequeue
    * Peek
